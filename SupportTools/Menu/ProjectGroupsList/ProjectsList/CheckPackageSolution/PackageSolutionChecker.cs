...
//პაკეტის სოლუშენის შემოწმების ლოგიკა. გამოიყენება როგორც ცალკე მენიუს ბრძანებიდან,
//ისე ყველა პაკეტის გავრცელების პროცესიდან
public sealed class PackageSolutionChecker
{
    ...
    public PackageSolutionChecker(ILogger logger, ParametersManager parametersManager, string projectName)
    {
        _logger = logger;
    ...
    public bool CheckPackageSolution()
    {
        ...
        //ეს შემოწმება მუშაობს მხოლოდ პაკეტის ტიპის პროექტებისთვის
