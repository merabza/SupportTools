...
public sealed class ProjectParametersClassCreator : CodeCreator
{
    ...
    public override void CreateFileStructure()
    {
        ...
        if (_useDatabase)
        {
            propertiesBlock.Add(new CodeBlock("public string? DatabaseConnectionName", true, "get", "set"));
            propertiesBlock.Add(new CodeBlock(
                "public Dictionary<string, DatabaseServerConnectionData> DatabaseServerConnections", "= []", true,
                "get", "set"));
            propertiesBlock.Add(new CodeBlock("public DatabaseParameters? DatabaseParameters", true, "get", "set"));
        }
        ...
        var block = new CodeBlock(string.Empty, new OneLineComment($"Created by {nameof(ProjectParametersClassCreator)} at {DateTime.Now}"),
