...
public sealed class ReactClientAppGitIgnoreCreator : CodeCreator
{
    public ReactClientAppGitIgnoreCreator(ILogger logger, string placePath, string? codeFileName = null) : base(logger,
