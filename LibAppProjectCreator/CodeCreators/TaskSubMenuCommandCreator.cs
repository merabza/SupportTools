...
public sealed class TaskSubMenuCommandCreator : CodeCreator
{
    ...
    public override void CreateFileStructure()
    {
        var block = new CodeBlock(string.Empty,
            new OneLineComment($"Created by {nameof(TaskSubMenuCommandCreator)} at {DateTime.Now}"), "using System",
            "using CliMenu", "using LibParameters", "using AppCliTools.CliParameters.CliMenuCommands",
